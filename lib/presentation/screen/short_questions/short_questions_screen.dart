                            ...
                            Expanded(
                                ...
                                child: Column(
                                  children: [
                                    GestureDetector(
                                      onTap: (){
                                        block.add(ClickYesBtn(context: context));
                                      },
                                      child: Container(
                                        alignment: Alignment.center,
                                        padding:
                                        ...
                                        child: Text((state.question == 1)?"male".tr():"yes".tr(),
                            ...
                            Expanded(
                                ...
                                child: Column(
                                  children: [
                                    GestureDetector(
                                      onTap: (){
                                        block.add(ClickNoBtn(context: context));
                                      },
                                      child: Container(
                                        alignment: Alignment.center,
                                        padding:
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            borderRadius:
                                                BorderRadius.circular(16)),
                                        child: Text((state.question == 1)?"female".tr():"no".tr(),
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodySmall),
                                      ),
